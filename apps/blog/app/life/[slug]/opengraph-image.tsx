...
export default async function Image({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const post = await fetchPostFromGitHub("life", slug);

  const title = post?.title || "Life Post";
    ...
    (
      <div
        style={{
          ...
          flexDirection: "column",
          justifyContent: "center",
          background: "linear-gradient(135deg, #1a0f08 0%, #5c2d0e 50%, #f97316 100%)",
          fontFamily: "system-ui, sans-serif",
          padding: 60,
          position: "relative",
        }}
