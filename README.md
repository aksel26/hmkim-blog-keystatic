...
인터랙티브 CLI로 주제를 입력하면 리서치부터 PR 생성까지 8단계를 거친다. 중간의 사용자 검토에서 반려하면 피드백을 반영해 최종본 생성(create)부터 다시 돌고, 전면 재작성을 고르면 초안(write)부터 다시 쓴다.
...
- **humanReview**: 검증 결과와 최종본을 보고 승인 또는 반려. 반려하면 리서치는 재사용하고, 피드백을 반영해 create부터 다시 돈다.
